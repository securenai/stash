...
export const HomeContent: React.FC<HomeContentProps> = () => {
	return (
		<div className="section">
			<h2>A Nifty Asset Manager</h2>
			<p>
				Hi ! Welcome to Stash! Stash is a place where you can save your favorite images,
				quotes and code snippets all in one place and we organize it for you!
			</p>
			<p>
				you can sort your data into catergories and you will be blown away by how easily
				you can access them and have them ready to share with family and friends!!
			</p>
			<p>
				we hope u can enjoy your stay and share with us how u think of this application!
			</p>
			<p>
